          ...
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-elegant">
            ...
            border: "1px solid #ECECEC"
              ...
              <h3 className="text-lg sm:text-xl font-display mb-6 sm:mb-8">
                Enterprise-grade architecture for SMEs
              </h3>

              <div className="space-y-4 sm:space-y-6">
                {[
                  { label: "Platforms:", value: "WhatsApp & Telegram" },
                  { label: "Data Providers:", value: "Sheets, Notion, Airtable, Supabase, Custom Data Sources" },
                  { label: "Model:", value: "Monthly subscription (per workspace)" },
                  { label: "Reliability:", value: "Model Routing Chain — 100% uptime" },
                  { label: "Automation:", value: "Morning + Evening + Monthly PDF" },
                ].map((row) => (
                  <div className="flex items-start gap-3" key={row.label}>
                    ...
                    <div className="flex-1">
                      <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                        <span className="font-semibold text-base">{row.label}</span> {row.value}
                      </div>
                    </div>
                  </div>
                ))}

      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              DayFlow: The Smart<br className="hidden sm:inline" />Business Assistant
            </h1>
            ...
            >
              Transform raw business data into actionable insights. DayFlow connects Google Sheets, Notion, Airtable, Supabase, and Custom Data Sources to WhatsApp & Telegram — turning your chat into a Smart Command Center for your business.
            </p>
